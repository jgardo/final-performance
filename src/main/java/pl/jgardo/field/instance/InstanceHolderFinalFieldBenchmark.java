...
public class InstanceHolderFinalFieldBenchmark {

    private static final Integer[] INTS = {1,2,3,4,5,6,7,8,9,0};

    private final ObjectHolder objectHolderFinal = new ObjectHolder(INTS);
    private ObjectHolder objectHolderNonFinal = new ObjectHolder(INTS);
    ...
    public static void main(String[] args) throws Exception {
        Options opt = new OptionsBuilder()
                .include(InstanceHolderFinalFieldBenchmark.class.getSimpleName())
                .forks(1)
